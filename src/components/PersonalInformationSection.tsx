  ...
  return (
    <div className="bg-black rounded-2xl flex flex-col gap-6 p-8 w-full">
      <div className="flex flex-row w-full gap-2">
        ...
        <h1 className="text-2xl font-medium text-teal-500">Personal Information</h1>
      </div>
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="flex flex-col gap-2">
           ...
           <p className="text-base font-medium text-white">{formatDateOfBirth(user.dob.date.toString())}</p>
        </div>
        <div className="flex flex-col gap-2">
